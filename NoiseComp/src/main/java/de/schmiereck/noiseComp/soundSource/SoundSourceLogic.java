...
implements GeneratorChangeListenerInterface, TimelineChangedListernerInterface
{
	...
	/**
	 * Is a buffer to store the output samples generated by {@link SoundSourceData#getOutputGenerator()}.
	 */
	 ...
	 * 			the timelines.
	 */
	public synchronized void setMainModuleGeneratorTypeData(final SoundSourceData soundSourceData, final ModuleGeneratorTypeData mainModuleGeneratorTypeData)
	{
		//==========================================================================================
		//------------------------------------------------------------------------------------------
		...
		//------------------------------------------------------------------------------------------
		soundSourceData.setOutputGenerator(null);
...
//		}
	...
	public void setOutputGenerator(final SoundSourceData soundSourceData, final Generator outputGenerator) {
		...
		if (Objects.nonNull(soundSourceData.getOutputGenerator())) {
			soundSourceData.getOutputGenerator().getGeneratorChangeObserver().removeGeneratorChangeListener(this);
		}
		...
		if (Objects.nonNull(soundSourceData.getOutputGenerator())) {
			...
			soundSourceData.getOutputGenerator().getGeneratorChangeObserver().registerGeneratorChangeListener(this);
		}		
		//==========================================================================================
	}
...
//	}
	 ...
	 * 			the sound sample.
	 */
	public SoundSample getFrameSample(final SoundSourceData soundSourceData, long frame) {
	...
	public void notifyGeneratorChanged(SoundSourceData soundSourceData, Generator generator, float changedStartTimePos, float changedEndTimePos)
	{
		...
		float timeLen = soundSourceData.getOutputGenerator().getEndTimePos(); // - this.outputGenerator.getStartTimePos();
