...
implements GeneratorChangeListenerInterface
{
	 ...
	 */
	public synchronized void setOutputGenerator(Generator outputGenerator)
	{
		//==========================================================================================
		if (this.outputGenerator != null)
		{
		...
		//------------------------------------------------------------------------------------------
		TimelineManagerLogic timelineManagerLogic = new TimelineManagerLogic();
		
		this.outputTimeline = timelineManagerLogic.createTimeline(this.outputGenerator);
