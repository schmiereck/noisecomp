...
extends TestCase
{
	...
	/**
	 * Einen einzelnen Node anhand eines XPath-Ausdrucks auswählen.
	 *
	 */
	...
	/**
	 * Eine Liste von Nodes anhand eines XPath-Ausdrucks auswählen.
	 *
	 */
	...
	public void testSelectNodeIterator()
	{
		...
		while ((elementNode = elementNodeIterator.nextNode()) != null)
		{
	...
	/**
	 * Den Text-Wert eines einzelnen Nodes anhand eines XPath-Ausdrucks auswählen.
	 *
	 */
	...
	/**
	 * Hängt einen neuen Node an einen bestehenden an.
	 *
	 */
	...
	/**
	 * Hängt einen neuen Node mit einem neuen TextNode an einen bestehenden an.
	 *
	 */
