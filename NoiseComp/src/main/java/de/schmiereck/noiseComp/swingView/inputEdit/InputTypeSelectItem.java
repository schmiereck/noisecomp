...
/**
 * <p>
 * 	Input-Type Select-Item for Combo-Box.
 * </p>
 * 
 * @author smk
 * @version <p>16.09.2010:	created, smk</p>
 */
public class InputTypeSelectItem
{
	//**********************************************************************************************
	// Fields:
	 ...
	 */
	public InputTypeSelectItem(InputTypeData inputTypeData)
	{
	...
	public boolean equals(Object obj)
	{
		...
		if (obj != null)
		{
			ret = this.inputTypeData == ((InputTypeSelectItem)obj).inputTypeData;
		}
		else
		{
			ret = false;
